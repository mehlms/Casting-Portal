...
define('IMAGE_SMALL_DIR', 'resources/assets/SmallProfileImg/');
define('IMAGE_SMALL_SIZE', 50);
define('IMAGE_MEDIUM_DIR', 'resources/assets/MediumProfileImg/');
...
if(isset($_FILES['image_upload_file'])){
	...
	elseif (round($_FILES['image_upload_file']["size"] / 1024) > 4096) {
		...
		//$uploaddirsmall = ;
		//$uploaddirmedium = '/resource/assets/MediumProfileImg';
		...
		//$path[1] = $uploaddirsmall . $fileNameNew;
		//$path[2] = $uploaddirmedium . $fileNameNew;
