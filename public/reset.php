...
$db->query("CREATE TABLE calls (id BIGINT PRIMARY KEY, d_id BIGINT, title VARCHAR(200), type INT, description TEXT, audition_location VARCHAR(100), audition_time VARCHAR(100), created_date DATETIME)");
