...
<form onsubmit='create(this); return false'>
  ...
  <div class="row">
    <div>
      ...
      <div class="row">
        <input type='text' placeholder='Project Title' name='title' spellcheck='false' autocomplete='off' maxlength='40'>
        <select name="type">
      ...
      <div class="row">
        <input type='text' placeholder='Audition Location' name='audition_location' spellcheck='false' autocomplete='off' maxlength='40'>
        <input type='text' placeholder='Audition Time' name='audition_time' spellcheck='false' autocomplete='off' maxlength='20'>
      </div>
      <textarea rows='2' spellcheck='false' autocomplete='off' maxlength='1000' placeholder="Project Description..." name="description"></textarea>
    </div>
  </div>
  <div>
    ...
    <div class="row">
      ...
      <input type='text' placeholder='Name' name='name_c1' spellcheck='false' autocomplete='off' maxlength='40'>
